        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-xl-3 col-lg-5 col-md-4" style="margin: 0px;padding: 0px;">
            <div class="fotosamping" style="height: 100%;">
              <img class="img-fluid" src="./assets_ip2022/img/potosampul25x.jpg" style="height: 100%;width: auto;object-fit: cover;object-position: right bottom;">
            </div>
          </div>

          <div class="col-xl-3 col-lg-5 col-md-5 p-4" style="background-color: #ffffff;">
          <form method="POST" autocomplete="off" action="{{ route('forgot-password') }}">
                        @csrf
            <div class="col-md-12 p-2">
              <p class="h4"><b>Lupa Password</b></p>
                <p class="belum-punya" style="color: #757575;font-size: 14px !important;">Pengaturan ulang password Anda akan dikirim melalui email
            </div>
            @if ( Session::get('error'))
                  <div class="alert alert-danger p-0 mb-1 text-center" role="alert">
                           <span style="font-size:12px;">{{ Session::get('error') }}</span>
                  </div>
               @endif
            ...
            <div class="row mb-5 p-2">
              <div class="col-md-6 col-sm-12">
                {{-- <div id="rr-element">
                  ...
                  <label for="rr-1">Simpan Akun</label>
                </div> --}}
              </div>
            </div>
            <div class="row mb-0 p-2">
              <div class="col-md-12 text-center">
                <button class="btn btn-indonesia-power" type="submit">Kirim Email</button>
              </div>
            </div>
            </form>
            <!-- FORM END -->
            ...
            <div class="container">
               <div class="row gy-4">
                  ...
                  <div class="col-lg-5 col-md-12 footer-links">
                     <h4>Kontak Kami</h4>
                     <ul>
                        <li><i class="bi bi-geo-alt"></i> <a href="#">Unit PLTP Kamojang – Jl. Raya Kamojang, Desa Laksana,<br>Kec. Ibun, Kab. Bandung – Jawa Barat 40384</a></li>
                        <li><i class="bi bi-telephone"></i> <a href="#">(022) 7814478, (0262) 229150</a></li>
                        <li><i class="bi bi-envelope"></i> <a href="#">humas.kmj@plnindonesiapower.co.id</a></li>
                     </ul>
                  </div>
                  <div class="col-lg-2 col-md-12 footer-contact text-md-start">
                     ...
                     <a href="https://www.instagram.com/plnip.ubpkamojang/"><img src="./assets_ip2022/img/instagram.png"></a>
                  </div>
               </div>
            </div>
         </div>
