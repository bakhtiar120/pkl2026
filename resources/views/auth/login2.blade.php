      ...
      <main id="main">
         ...
         <section id="login-akun" class="login-akun">
            <div class="container d-flex justify-content-center my-5" data-aos="fade-up">
               ...
               <div class="row gx-0">
                  <div class="col-sm">
                     <img class="foto-login" src="./assets_ip2022/img/foto_register.png" />
                  </div>
                  <div class="col-sm">
                     <div class="col-lg-6">
                        <form method="POST" autocomplete="off" action="{{ route('login') }}" class="php-email-form">
                        @csrf
                           <p class="title-register">Selamat Datang di</p>
                           <!-- <p class="subtitle-register">PKL Online Kamojang</p> -->
                           ...
                           <div class="row gy-4">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="input-group" id="show_hide_password">
                                       ...
                                       <div class="input-group-append">
                                          <a href="" class="btn rounded-end button_top"><i class="bi bi-eye-slash"
                              ...
                              <div class="col-md-6">
                                 <p id="label-lupa-password">Lupa Password?</p>
                              </div>
                              <div class="col-md-12 text-center">
                        
                                 <button type="submit">Masuk</button>
                              </div>
                              <p class="belum-punya" style="margin-top: 5px;"> 
                   
                              Belum Punya akun?<a href="register" class="belum-punya-biru">Daftar  Sekarang</a>  </p>
                        </form>
                        </div>
                     </div>
                  </div>
