                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-xl-3 col-lg-5 col-md-5 p-4" style="background-color: #ffffff;">
                        <form method="POST" autocomplete="off" action="{{ route('login') }}">
                            ...
                            <div class="col-md-12 p-2">
                                <p class="h4"><b>Masuk ke Akun Anda</b></p>
                                <p class="belum-punya" style="color: #757575;font-size: 14px !important;">Belum Punya
                                    Akun?
                                    <a href="register" class="belum-punya-biru"
                                        style="font-size: 14px !important;font-weight: 600;">Daftar</a>
                                </p>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" id="show_hide_password">
                                            ...
                                            <div class="input-group-append">
                                                <a href="" class="btn btn-light rounded-right"
                                                    style="border-color: #ced4da;border-radius: 0px 4px 4px 0px;"><i
                  ...
                  <label for="rr-1">Simpan Akun</label>
                                ...
                                <div class="col-md-6 col-sm-12 d-flex justify-content-end align-items-center">
                                    <p id="label-lupa-password" class="mb-0">
                            ...
                            <div class="row mb-0 p-2">
                                <div class="col-md-12 text-center">
                                    <button class="btn btn-indonesia-power" type="submit">Masuk</button>
                                </div>
                            </div>
                        </form>
                        <!-- FORM END -->
