      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-compact nav-child-indent nav-collapse-hide-child nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                <a href="{{ route('mentor.dashboard')}}" class="nav-link {{ (request()->is('user/dashboard*')) ? 'active' : '' }}">
               ...
               <li class="nav-item">
                <a href="{{ route('mentor.profile')}}" class="nav-link {{ (request()->is('user/profile*')) ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ route('mentor.settings')}}" class="nav-link {{ (request()->is('user/settings*')) ? 'active' : '' }}">
