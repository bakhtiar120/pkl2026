                                ...
                                <table class="table table-hover" id="dataTable1" width="100%" cellspacing="0">
                                    ...
                                    @foreach ($member_not_verified as $member_1)
                                      <tr>
                                        ...
                                        <td>
                                          <a href="javascript:void(0)" class="btn btn-sm btn-outline-success terima-magang" data-id="{{ $member_1->id_member }}"><i class="fas fa-solid fa-check fa-sm pr-1"></i>Terima</a>
                                          <a href="javascript:void(0)" class="btn btn-sm btn-outline-danger tolak-magang" data-id="{{ $member_1->id_member }}"><i class="fas fa-solid fa-times fa-sm pr-1"></i>Tolak</a>
