...
<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb pl-0">
          <li class="breadcrumb-item"><a href="/admin/pendaftaran_selesai">Pendaftaran selesai</a></li>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-3 mb-2">
                            <div class="text-xs font-weight-bold text-new text-uppercase mb-1">
                                Bidang</div>
                            <div class="h6 mb-0 font-weight-bold text-gray-800">{{$query_pendaftaran->nama_bidang}}</div>
                        </div>
                        <div class="col-xl-3 col-md-3 mb-2">
                            <div class="text-xs font-weight-bold text-new text-uppercase mb-1">
                                Kuota / Peserta Lolos</div>
                            <div class="h6 mb-0 font-weight-bold text-gray-800">{{$query_pendaftaran->jumlah_kuota}} / {{$jumlah_lolos}}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                          <a class="nav-link active" id="belumverifikasi-tab" data-toggle="tab" href="#belumverifikasi" role="tab" aria-controls="belumverifikasi" aria-selected="true">Belum Verifikasi</a>
                        </li>
                        <li class="nav-item" role="presentation">
                          <a class="nav-link" id="lolos-tab" data-toggle="tab" href="#lolos" role="tab" aria-controls="lolos" aria-selected="false">Lolos</a>
                        </li>
                        <li class="nav-item" role="presentation">
                          <a class="nav-link" id="tidaklolos-tab" data-toggle="tab" href="#tidaklolos" role="tab" aria-controls="tidaklolos" aria-selected="false">Tidak lolos</a>
                        </li>
                      </ul>
                    <!-- nav tabs end -->
                    <!-- tab content -->
                      <div class="tab-content" id="myTabContent">
                        <!-- belum verifikasi -->
                        <div class="tab-pane fade show active" id="belumverifikasi" role="tabpanel" aria-labelledby="belumverifikasi-tab">
                            <div class="table-responsive mt-4">
                                <table class="table table-hover" id="dataTable1" width="100%" cellspacing="0">
                                    ...
                                    @foreach ($member_not_verified as $member_1)
                                      <tr>
                                        <td>{{date("Ym",strtotime($member_1->created_at_)).$member_1->id_member}}</td>
                                        <td>{{$member_1->nama_lengkap}}</td>
                                        <td>
                                            <a href="/admin/detail-profile/{{ $member_1->id_member }}"><button type="button" class="btn btn-sm btn-outline-new">Detail</button></a>
                                        </td>
                                        <td>
                                        <a href="{{ url('/admin/terima-magang/') }}/{{$member_1->id_member}}"><button type="button" class="btn btn-sm btn-outline-success">Terima</button></a>
                                        <a href="{{ url('/admin/tolak-magang/') }}/{{$member_1->id_member}}"> <button type="button" class="btn btn-sm btn-outline-danger">Tolak</button></a>
                                        <button onclick="showModal({{$member_1->id_member}})" type="button" class="btn btn-sm btn-outline-warning">Ubah Bidang</button>
                                        </td>
                                      </tr>
                                      @endforeach
                                    </tbody>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            ...
                                            <button onclick="showModal({{$member1->id_member}})" type="button" class="btn btn-sm btn-outline-warning">Ubah Bidang</button>
                                        </td>
                                      </tr>
                                      @endforeach
                                    </tbody>
                            ...
                            <div class="table-responsive mt-4">
                                <table class="table table-hover" id="dataTable3" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td>{{date("Ym",strtotime($membernl->created_at_)).$membernl->id_member}}</td>
                                        <td>{{$membernl->nama_lengkap}}</td>
                                        <td>
                                            <a href="/admin/detail-profile/{{ $membernl->id_member }}"><button type="button" class="btn btn-sm btn-outline-new">Detail</button></a>
                                            <button onclick="showModal({{$membernl->id_member}})" type="button" class="btn btn-sm btn-outline-warning">Ubah Bidang</button>
                                        </td>
                                      </tr>
                                      @endforeach
                                    </tbody>
