                        ...
                        <div class="row">
                            <div class="col mb-2">
                                ...
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                    {{ date('d F Y', strtotime($query_pendaftaran->tgl_mulai_pendaftaran)) }}<br>{{ date('d F Y', strtotime($query_pendaftaran->tgl_selesai_pendaftaran)) }}
                                </div>
                            </div>
                            <div class="col mb-2">
                                <div class="text-xs font-weight-bold text-new text-uppercase mb-1">
                                ...
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                    {{ date('d F Y', strtotime($query_pendaftaran->tgl_mulai_pelaksanaan)) }}<br>{{ date('d F Y', strtotime($query_pendaftaran->tgl_selesai_pelaksanaan)) }}
                                </div>
                            </div>
                            <div class="col mb-2">
                                <div class="text-xs font-weight-bold text-new text-uppercase mb-1">
                            ...
                            <div class="col mb-2">
                                <div class="text-xs font-weight-bold text-new text-uppercase mb-1">
                                    Bidang</div>
                                <div class="h6 mb-0 font-weight-bold text-gray-800">{{ $query_pendaftaran->nama_bidang }}
                                </div>
                            </div>
                            <div class="col mb-2">
                                <div class="text-xs font-weight-bold text-new text-uppercase mb-1">
                                    Kuota / Peserta Lolos</div>
                                <div class="h6 mb-0 font-weight-bold text-gray-800">{{ $query_pendaftaran->jumlah_kuota }} /
                                    {{ $jumlah_lolos }}</div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            @foreach ($member_not_verified as $member_1)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ url('/admin/terima-magang/') }}/{{ $member_1->id_member }}"><button
                                                                type="button"
                                                                class="btn btn-sm btn-outline-success">Terima</button></a>
                                                        <a
                                                            href="{{ url('/admin/tolak-magang/') }}/{{ $member_1->id_member }}">
                                                            <button type="button"
                                                                class="btn btn-sm btn-outline-danger">Tolak</button></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/admin/detail-profile/{{ $member1->id_member }}"><button
                                                                type="button"
                                                                class="btn btn-sm btn-outline-new">Detail</button></a>
                                                        <button onclick="showModal({{ $member1->id_member }})"
                                                            type="button" class="btn btn-sm btn-outline-warning">Ubah
                                                            Bidang</button>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/admin/detail-profile/{{ $membernl->id_member }}"><button
                                                                type="button"
                                                                class="btn btn-sm btn-outline-new">Detail</button></a>
                                                        <button onclick="showModal({{ $membernl->id_member }})"
                                                            type="button" class="btn btn-sm btn-outline-warning">Ubah
                                                            Bidang</button>
                                                    </td>
                                                </tr>
