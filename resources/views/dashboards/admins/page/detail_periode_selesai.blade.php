...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h5 mb-0 text-gray-800">Detail Periode</h1>
        </div>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-3 mb-2">
                                ...
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                    {{ date('d F Y', strtotime($periodes[0]->tgl_mulai_pendaftaran)) }}<br>{{ date('d F Y', strtotime($periodes[0]->tgl_selesai_pendaftaran)) }}
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-3 mb-2">
                                <div class="text-xs font-weight-bold text-new text-uppercase mb-1">
                                ...
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                    {{ date('d F Y', strtotime($periodes[0]->tgl_mulai_pelaksanaan)) }}<br>{{ date('d F Y', strtotime($periodes[0]->tgl_selesai_pelaksanaan)) }}
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-3 mb-2">
                                <div class="text-xs font-weight-bold text-new text-uppercase mb-1">
                                ...
                                <tbody>
                                    @foreach ($bidangs as $bidang)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    href="{{ url('/admin/detail-bidang-pendaftaran-selesai/') }}/{{ $bidang->id }}">
                                                    <button type="button"
