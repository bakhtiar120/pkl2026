     ...
     <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              <li class="breadcrumb-item"><a href="{{ url()->previous() }}"><i class="fas fa-fw fa-solid fa-arrow-left"></i>Kembali</a></li>
            </ol>
          </nav>
              ...
              @include('sweetalert::alert')
                    <div class="row">
                      <div class="col-md-12 col-md-offset-1 mb-4">
                        <h4 class="pt-4">Nomor Pendaftaran : {{date("Ym",strtotime($data_user->created_at_)).$data_user->id}} <b class="id"></b></h3>
                        <h5>Tanggal Pendaftaran :  {{date('d F Y', strtotime($data_user->created_at_))}}<b class="tgl"></b></h5>
                      </div>
                    </div>
                    <div class="d-flex justify-content-between" style="text-align: right">
                        <div class="col-md-2 col-md-offset-1">
                            <div class="alert alert-success text-center"><b class="nama-bidang">{{ $data_user->nama_bidang }}</b></div>
                        </div>
                        <div class="col-md-10 col-md-offset-1">
                          <a href="javascript:void(0)" class="btn btn-sm btn-outline-new reset-password" data-id="{{ $data_user->id }}">
                            Reset Password</a>
                        </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12 col-md-offset-1">
                        <div class="row">
                          <div class="col-sm-2">
                            <img style="" class="img-thumbnail pas_foto" src="{{ $data_user->berkas_pas_foto }}"
                          ...
                          <style>
                            ...
                            <table class="table table-sm table-borderless">
                              ...
                              <tr>
                                ...
                                <td class="nama_lengkap" colspan="2">{{$data_user->nama_lengkap}}</td>
                              </tr>
                              <tr>
                                <td class="td1">Tempat Tanggal Lahir</td>
                                <td class="ttl" colspan="2">{{$data_user->tempat_lahir}}, {{date('d F Y', strtotime($data_user->tanggal_lahir))}}</td>
                              </tr>
                              <tr>
                                <td class="td1">Jenis Kelamin </td>
                                <td class="jenis_kelamin" colspan="2">{{$data_user->jenis_kelamin}} </td>
                              </tr>
                              <tr>
                                <td class="td1"> Agama</td>
                                <td class="agama" colspan="2">{{$data_user->agama}} </td>
                              </tr>
                              <tr>
                                <td class="td1"> Alamat</td>
                                <td class="alamat" colspan="2">{{$data_user->alamat}}</td>
                              </tr>
                              <tr>
                                <td class="td1"> Nomor Handphone</td>
                                <td class="nomor_handphone" colspan="2">{{$data_user->nomor_handphone}}</td>
                              </tr>
                              <tr>
                                <td class="td1"> Email</td>
                                <td class="nomor_handphone" colspan="2">{{$data_user->email}}</td>
                              </tr>
                              <tr>
                                <td colspan="3">
                                  <hr>
                              ...
                              <tr>
                                <td class="td1">Nama Lengkap</td>
                                <td class="nama_dosen_pembimbing" colspan="2">{{$data_user->nama_dosen_pembimbing}}</td>
                              </tr>
                              <tr>
                                <td class="td1">Jenis Kelamin </td>
                                <td class="jenis_kelamin_dosen_pembimbing" colspan="2">{{$data_user->jenis_kelamin_dosen_pembimbing}}</td>
                              </tr>
                              <tr>
                                <td class="td1"> Email</td>
                                <td class="email_dosen_pembimbing" colspan="2"> {{$data_user->email_dosen_pembimbing}}</td>
                              </tr>
                              <tr>
                                <td class="td1"> Nomor Handphone</td>
                                <td class="nomor_handphone_dosen_pembimbing" colspan="2">{{$data_user->nomor_handphone_dosen_pembimbing}} </td>
                              </tr>
                              <tr>
                                <td colspan="3">
                                  <hr>
                              ...
                              <tr>
                                ...
                                <td class="nama_perguruan_tinggi" colspan="2">{{$data_user->nama_perguruan_tinggi}}</td>
                              </tr>
                              <tr>
                                <td class="td1">Alamat</td>
                                <td class="alamat_perguruan_tinggi" colspan="2">{{$data_user->alamat_perguruan_tinggi}}</td>
                              </tr>
                              <tr>
                                <td class="td1"> Fakultas </td>
                                <td class="fakultas" colspan="2">{{$data_user->fakultas}}</td>
                              </tr>
                              <tr>
                                <td class="td1"> Program Studi</td>
                                <td class="program_studi" colspan="2">{{$data_user->program_studi}}</td>
                              </tr>
                              <tr>
                                <td colspan="3">
                                  <hr>
                              ...
                              <tr>
                                ...
                                <td colspan="2">
                                  <button type="button" dataurl="{{$data_user->bekas_syarat_pendaftaran}}" class="btn btn-sm btn-outline-new lihat_berkas">
                              ...
                              <tr>
                                ...
                                <td colspan="2">
                                  <button type="button"  dataurl="{{$data_user->berkas_pas_foto}}" class="btn btn-sm btn-outline-new lihat_pas_foto">
                                    <span class="btn-label"><i class="fa fa-eye"></i></span>
                                  </button>
                                </td>
                              </tr>
...
//     $.get( `/mentor/api/profil-member/{{$request->id}}`).done(function( data ) {
//       //console.log(data);
//       if(data.data){ 
//         set_value(data.data);
...
//   $.get( `/mentor/api/get-pendaftaran/${id}`).done(function( data ) {  
