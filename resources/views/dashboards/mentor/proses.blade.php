            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="{{ route('logout') }}"
                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Keluar&nbsp;<i
                ...
                <div class="row pt-5 ">
                    ...
                    <div class="col-lg-12">
                        <div class="alert alert-primary text-center" role="alert">
                            Anda telah menyelesaikan pendaftarn PKL Online. Pengumuman hasil lulus administrasi dapat
                            dilihat pada halaman Info PKL
                        </div>
                    </div>
                                ...
                                <div class="col-md-12 col-md-offset-1">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <br>
                                            <div class="alert alert-success2">Bidang <b class="nama-bidang"></b></div>
                                            <img style="max-width: 211px;" class="img-thumbnail pas_foto"
                                                src="/assets_ip2022/img/no-image.png" class="rounded float-left"
                                                alt="...">
                                        </div>
                            ...
                            <div class="col-md-12" style="text-align: left;">
                                ...
                                <div class="col-md-12">
                                    <p class="p-4">
                                        ...
                                        <span style="float: left;">7.&nbsp;</span><span style="display: flex;">Surat
                                            Kesediaan<br></span>
                                    </p>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row gy-4">
                    ...
                    <div class="col-lg-3 col-md-12 footer-contact text-md-start">
                        ...
                        <img src="/assets_ip2022/img/Facebook.png" width="32px" height="32px"
    ...
    <script>
        ...
        function get_pendaftaran(id) {
            $.get(`/user/api/get-pendaftaran/${id}`).done(function(data) {
                ...
                switch (data.data.status_pendaftaran) {
                    case 'Lolos':
                        location.replace('/user/home');
                        break;
                    case 'Proses':
                        location.replace('/user/pendaftaran-pkl-online');
                        break;
                    case 'Tidak Lolos':
                        location.replace('/user/pendaftaran-pkl-online');
                        break;
        ...
        function set_value(data) {
            ...
            $(`.id`).html(moment(data.created_at).locale('id').format('YYYY MMMM') + data.id);
