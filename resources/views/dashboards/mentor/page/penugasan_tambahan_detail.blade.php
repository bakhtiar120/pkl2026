     ...
     <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb pl-0">
                          <li class="breadcrumb-item"><a href="/mentor/penugasan">Penugasan</a></li>
...
function showModalhapus(id) {
    ...
    if (result.isConfirmed) {
        ...
        $.post( "/mentor/api/hapus-penugasan",{id: window.dataId}).done(function(data){
             swalWithBootstrapButtons.fire(
            'Dihapus!',
...
$(document).ready(function() {
    ...
    $('#FormAdd').submit( function (event) { 
        ...
        $.ajax({
            type: "post",
            url: '/mentor/api/tambah-penugasan',
            data: formData,
            contentType: false,
            processData: false,
            success: function(x){
