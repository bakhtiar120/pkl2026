...
@if($akses != null) 
  @if($akses->status_pendaftaran == 'Belum Verifikasi')
    <script>window.location = "/user/proses";</script>
                  ...
                  <form id="formdatadiri" class="f1">
                    ...
                    <fieldset> 
                           ...
                           @csrf
                            <div class="col-sm-6">
                              <div class="form-group pt-4">
                                ...
                                <input class="form-control" name="nama_lengkap" value="" type="text" placeholder="Nama Lengkap" required>
                              </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group pt-4">
                              ...
                              <input class="form-control" name="nim" value="" type="number" placeholder="Nomer Induk Mahasiswa" required>
                            </div>                           
                          </div>
                          <div class="col-sm-6">
                          </div>
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group pt-4">
                                ...
                                <input class="form-control" name="tempat_lahir" value="" type="text" placeholder="Tempat Lahir">
                              </div>
                            </div>
                            <div class="col-sm-6">
                              <div class="form-group pt-4">
                            ...
                            <div class="col-sm-6">
                              <div class="form-group pt-4">
                                ...
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" name="jenis_kelamin" type="radio" id="inlineradio1" value="Laki Laki" checked>
                                  <label class="form-check-label"  for="inlineradio1">Laki Laki</label>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" name="jenis_kelamin" type="radio" id="inlineradio2" value="Perempuan">
                                  <label class="form-check-label" for="inlineradio2">Perempuan</label>
                                </div>
                              </div>
                              <div class="form-group pt-4">
                                <label>Agama</label>
                                <select class="form-select" value="" id="agama" name="agama">
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group pt-4">
                                ...
                                <input class="form-control" name="nomor_handphone" type="number" placeholder="Nomor Handphone">
                              </div>
                            </div>
                            <div class="col-sm-6">
                            </div>
                        ...
                        <div class="col-sm-9">
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group pt-4">
                                ...
                                <input class="form-control" type="text" name="nama_dosen_pembimbing" placeholder="Nama Lengkap">
                              </div>
                            </div>
                            <div class="col-sm-6">
                            </div>
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group pt-4">
                                <label>Jenis Kelamin</label><br>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" name="jenis_kelamin_dosen_pembimbing" type="radio" id="jeniskelamindosenpembimbing" value="Laki Laki" checked>
                                  <label class="form-check-label" for="jeniskelamindosenpembimbing">Laki Laki</label>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" name="jenis_kelamin_dosen_pembimbing" type="radio" id="jeniskelamindosenpembimbing1" value="Perempuan">
                                  <label class="form-check-label" for="jeniskelamindosenpembimbing1">Perempuan</label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-6">
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group pt-4">
                                <label>Email</label>
                                <input name="email_dosen_pembimbing" class="form-control" type="email" placeholder="Email">
                              </div>
                            </div>
                            <div class="col-sm-6">
                            </div>
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group pt-4">
                                <label>Nomor Handphone</label>
                                <input name="nomor_handphone_dosen_pembimbing" class="form-control" type="number" placeholder="Nomor Handphone">
                              </div>
                            </div>
                            <div class="col-sm-6">
                            </div>
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group pt-4">
                                ...
                                <input name="nama_perguruan_tinggi" class="form-control" type="text" placeholder="Nama perguruan Tinggi Peserta">
                              </div>
                            </div>                          
                          </div>
                          <div class="row">
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group pt-4">
                                ...
                                <input name="kota_universitas" class="form-control" type="text" placeholder="Kota Perguruan Tinggi Peserta">
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="col-sm-6">
                              <div class="form-group pt-4">
                                  ...
                                  <label>Fakultas</label>
                                    <select  name="fakultas"  class="form-select" value="" id="agama" name="agama">
                              ...
                              <div class="form-group pt-4"> 
                                  ...
                                  <input name="program_studi" class="form-control" type="text" placeholder="Program Studi">
                                </div>
                            </div>
                            <div class="col-sm-6">
                            </div>
                      ...
                      <div class="row">
                        <div class="f1-buttons pt-4"> 
                          <button class="btn btn-sm btn-primary2 btn-next">Selanjutnya </button>
                        </div>
                      </div>
                   ...
                   <fieldset>
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                        <div class="alert alert-info text-center">Pastikan ukuran dan format file yang diunggah sesuai dengan ketentuan.</div>
                          <!-- Form Upload file -->
                          <div class="row">
                            <div class="col-sm-9">
                              <div class="form-group pt-4">
                                <label class="control-label">Berkas Syarat Pendaftaran Dalam 1 File <i style="color:#2B2E7A ;" data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="bi bi-info-circle-fill" ></i></label>&nbsp;
                                <label style="color: darkgrey;">(max. 5 Mb format .pdf)</label>
                                <div class="input-group custom-file-button">
                                  <label class="input-group-text" for="berkas">
                                    <i class="fa fa-paperclip"></i>&nbsp;Pilih File
                                  </label>
                                  <input type="file" accept=".pdf" name="fileberkas" id="berkas" class="form-control" id="berkas">
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-3">
                              <div class="position-relative t-btn-mobile">
                                <div class="position-absolute bottom-0 start-0">
                                  <button dataurl="" type="button" class="btn btn-labeled btn-outline-primary2 lihat_berkas" disabled>
                                    <span class="btn-label"><i class="fa fa-eye"></i>&nbsp;Lihat</span>
                                  </button>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-sm-9">
                              <div class="form-group pt-4">
                                <label class="control-label">Pas Foto 3x4 &nbsp;</label>
                                <label style="color: darkgrey;">(max. 500Kb format .jpg)</label>
                                <div class="input-group custom-file-button">
                                  <label class="input-group-text" for="pasfoto">
                                    <i class="fa fa-paperclip"></i>&nbsp;Pilih File
                                  </label>
                                  <input accept="image/*" type="file" name="filepasfoto" class="form-control" id="pasfoto">
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-3">
                      ...
                      <div class="f1-buttons pt-4">
                        <button type="button" class="btn btn-light2 btn-previous"> Kembali</button>
                        <button type="button" class="btn btn-sm btn-primary2 btn-next btn-next-upload" disabled>Selanjutnya </button>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group pt-4">
                                ...
                                <select class="form-select" id="id_kuota" name="id_kuota"> 
                                </select>
                              </div>
                            </div>
                            <div class="col-sm-6">
                          ...
                          <div class="row">
                            <div class="f1-buttons pt-4">
                            <button type="button" class="btn btn-light2 btn-previous"> Kembali</button>
                              <button type="button" type="submit" class="btn btn-sm btn-primary2 btn-next simpan-kuota">Selanjutnya </button>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <fieldset>
                      ...
                      <div class="f1-buttons pt-4">
                        <button type="button" class="btn btn-light2 btn-previous"> Kembali</button>
                        <button class="btn btn-sm btn-primary2 btn-next validasi-pendaftaran">Validasi dan Selesaikan Pendaftaran</button>
                      </div>
                    </fieldset>  
                </div>
              </form>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('.f1 .btn-next').on('click',function() {
        ...
        // validasi form
        parent_fieldset.find('input[type="text"], input[type="password"],input[type="number"],input[type="date"], textarea').each(function() {
  ...
  function set_value(data){
        ...
        $(`:input[name='jenis_kelamin_dosen_pembimbing'][value='${data.jenis_kelamin_dosen_pembimbing}']`).prop(`checked`, true);;
